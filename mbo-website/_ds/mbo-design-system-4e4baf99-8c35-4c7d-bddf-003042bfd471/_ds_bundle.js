/* @ds-bundle: {"format":4,"namespace":"MBODesignSystem_4e4baf","components":[{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Divider","sourcePath":"components/core/Divider.jsx"},{"name":"Input","sourcePath":"components/core/Input.jsx"}],"sourceHashes":{"components/core/Badge.jsx":"62c0b5165c1f","components/core/Button.jsx":"7396db46699a","components/core/Card.jsx":"b60ebf713244","components/core/Divider.jsx":"13a756410876","components/core/Input.jsx":"710c26ab4c0f","deck-stage.js":"0cc26af2402a"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.MBODesignSystem_4e4baf = window.MBODesignSystem_4e4baf || {});
...
function Badge({
  ...
  const variantStyles = {
    brand: {
      background: 'var(--color-acero-verde)',
      color: 'var(--color-lamina-clara)'
    },
    dark: {
      background: 'var(--color-grafito-modular)',
      color: 'var(--color-lamina-clara)'
    },
    accent: {
      background: 'var(--color-madera-terra)',
      color: 'var(--color-lamina-clara)'
    },
    outline: {
      background: 'transparent',
      color: 'var(--color-acero-verde)',
      border: '1px solid var(--color-acero-verde)'
    },
    'outline-light': {
      background: 'transparent',
      color: 'var(--color-lamina-clara)',
      border: '1px solid var(--color-lamina-clara)'
    },
    subtle: {
      background: 'var(--color-acero-verde-08)',
      color: 'var(--color-acero-verde)'
    }
  };
  const sizeStyles = {
...
function Button({
  ...
  const variantStyles = {
    primary: {
      background: 'var(--color-acero-verde)',
      color: 'var(--color-lamina-clara)',
      border: '2px solid var(--color-acero-verde)'
    },
    dark: {
      background: 'var(--color-grafito-modular)',
      color: 'var(--color-lamina-clara)',
      border: '2px solid var(--color-grafito-modular)'
    },
    accent: {
      background: 'var(--color-madera-terra)',
      color: 'var(--color-lamina-clara)',
      border: '2px solid var(--color-madera-terra)'
    },
    ghost: {
      background: 'transparent',
      color: 'var(--color-acero-verde)',
    ...
    'ghost-dark': {
      background: 'transparent',
      color: 'var(--color-grafito-modular)',
      border: '2px solid var(--color-grafito-modular)'
    },
    'ghost-light': {
      background: 'transparent',
      color: 'var(--color-lamina-clara)',
      border: '2px solid var(--color-lamina-clara)'
    }
  };
  const sizeStyles = {
    sm: {
...
function Card({
  ...
  const variantStyles = {
    default: {
      background: 'var(--color-lamina-clara)',
      color: 'var(--color-grafito-modular)'
    },
    dark: {
      background: 'var(--color-grafito-modular)',
...
function Divider({
  ...
  const colors = {
    ...
    brand: 'var(--color-acero-verde)',
    dark: 'var(--color-grafito-modular)',
    accent: 'var(--color-madera-terra)',
    light: 'var(--color-border-light)',
    subtle: 'var(--color-acero-verde-08)'
  };
...
function Input({
  ...
  return React.createElement('div', {
    ...
    style: {
      ...
      letterSpacing: '0.16em',
      textTransform: 'uppercase',
      color: error ? 'var(--color-madera-terra)' : 'var(--color-acero-verde)'
    }
    ...
    style: {
      ...
      color: 'var(--color-grafito-modular)',
      background: 'var(--color-lamina-clara)',
      border: error ? '2px solid var(--color-madera-terra)' : '1px solid var(--color-acero-verde-30)',
      borderRadius: 0,
      padding: '12px 16px',
      outline: 'none',
      width: '100%',
